...
DATA_PATH="/home/xinyuya2/jinwei/nsa/CS441-Trainable-Sparse-Attention-for-LLM-Inference-Acceleration/fine_tune/data/gsm8k"

# Training hyperparameters
BATCH_SIZE=2  # Small batch for memory efficiency
GRAD_ACCUM=64   # Reduced from 16 for more frequent updates (better for distillation)
...
LOSS_MODE="ce"       # Loss mode: kl_output_only (default, most efficient), kl_logits, mse_hidden, ce,or mixed
