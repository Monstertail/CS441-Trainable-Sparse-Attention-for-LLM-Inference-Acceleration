...
args.add_argument('--data_path', type=str, default='/path/to/data/dir', help='Root path to dataset files')
arg = args.parse_args()
...
base_tokenizer = AutoTokenizer.from_pretrained(large_model_id)
assistant_tokenizer = AutoTokenizer.from_pretrained(small_model_id)
...
training_args = TrainingArguments(
    ...
    save_strategy='epoch',
    save_safetensors=False, #jinwei: sharing module causes error for safetensors
    learning_rate=2e-5,
